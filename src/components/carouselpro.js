...
class Carouselpro extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Carousel.Item>
      <a target="_blank" href="https://github.com/annamariapl/data-protection-form">
      <img
      ...
      <p>TOM: technical and organizational measures. <br/> </p> 

      <p> <strong> What the App does: </strong></p>

      <p>The Data from a <span className="highlight">YAML file lands in a database </span> via seed.rb. <br/>
      The data populates a formular (Simple_From: checkboxes and text fields.</p>

        <p> <span className="highlight">Security Check</span>
        <br/>After clicking the button 'Click - check...' the app displayes a "percentage of security" 
        (real logic not implemented, 'placeholder logic').</p>

        <p> <span className="highlight">Saving to .docx format</span> <br/>The collected Data Choices are being saved into a .docx (word document- setup with Caracal Gem). 
        The Data can be manipulated directly in agreeements_controller.rb. 
        The structure of the .docx document is of course not real and definitly not final - due to know-how protecting.</p>

        <p> <span className="highlight">Sends an E-Mail with doc Datei</span><br/>The doc is being send to an E-Mail (configured with Postfix). 
        A safety copy of the document is being stored to a folder as well.</p>

        <p>Next steps: <br/>
        1) exchange yml for csv to make it excel compatable., <br/>
      2) Add text-field with prefilled, changeable text. 
