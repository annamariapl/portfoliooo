    ...
    return (
      <div className="main projects">
        <div onClick={() => this.handleAClick(-1)} className="projetcs">
          ...
          <Infobox text="With an exprience I have gained during my internship at Small Improvements Software GmbH (2019) I would approach many of my older projects differently." />
        </div>
